...
**TODO** *We are going to need to introduce some new boilerplate. As it stands, the current solutions are doing while(ros::ok()) as a sort of pseudo setup/loop strucutre. This will need to either be made to look more like Arduino code or we will need to explain what's going on here*
...
**TODO** *This might still be doable if we make an LCD on the screen, but we're gonna have to redesign this whole section*
...
**TODO** *Do we need any kind of delay? I think not, but this wouldn't be difficult to replace with sleep()*
