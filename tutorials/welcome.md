...
This week you will go through a partially self-paced tutorial on how to program your robot. Your tutorial will be interspersed with instruction, activities on the robot, and outside activities like visits to tech companies and lectures from scientists working in robotics. We have done everything that we could think of to pack as much fun as possible into this week.
...
* When the red cup is facing upward, it means:
   ...
   * I have completed an exercise or tutorial, and am ready for camp staff to mark my progress.
...
* Put the person on the top of your team sheet as Camper 0, and the one at the bottom as Camper 1. These numbers do not indicate rank or seniority, nor do they indicate that either of you is a zero or number one. They track your hours.
...
Everyone in this camp has a virtually identical robot.

In order to tell them apart, when they could become mixed up, write your team number on a sticky note and stick it to the top of the robot.

## Tutorials

Everyone will work and learn at a different pace. To accomodate this, this camp comprises a series of partially self-paced tutorials. Each of these tutorials is documented on this website. You can easily navigate the tutorials using the navigation bar on the left. You can always return to the top of the website by clicking on the "Texas RoboCamp" logo in the upper left-hand corner.

## Activities

Groups of tutorials add up to activities. Once you have learned enough skills to perform an activity, you will implement a programming challege to make your robot do a new thing. If you complete all of the tutorials and activities, there are "customized activities" at the end of the camp, which invite you to become creative in the way that you use what you have learned or improve the performance of something that you have written to try to improve the performance of your robot.
...
>- **RED CUP: Track Progress [Tutorial 1]**
>- Please flip your cup to red.

At this point, please **actually** flip your cup to red in order to indicate that you have reached this point in the tutorial.

## Next Step

Proceed to ["Using the Arduino IDE."](/arduino.html)