...
**TODO** *We mention that this is introductory reading material. Honestly I think this is still useful information and we could make a new page talking about Gazebo and explain how even though we're in a virtual situation, working in simulations based on real hardware is something done in real life too*
...
**TODO** *I mentioned this in the Linux setup pages as well - do we want to introduce them to an IDE? Code completion might make their lives too easy...*
...
*We could, in theory, explore adding LED functionality to the simulated robot. Might be interesting to show it, and then make it a part of the bonus material to either have them program the virtual LEDs with a wrapper - or even not use a wrapper and have this be the part where we introduce the more advanced kids to ROS*
...
*Maybe include a note here about troubleshooting for if the test binaries we make don't work*
